...
import static com.dylanensor.sleepysnacks.SleepySnacksMod.createIdentifier;
...
public class GeneratorRegistry {
    ...
    public static final SimpleBlockConfiguration config = (new SimpleBlockConfiguration(
            new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder()
                    .add(Content.ARUGULA.asBlock().defaultBlockState().setValue(SleepySnacksCropBlock.AGE, 7), 10)
                    .build())));
